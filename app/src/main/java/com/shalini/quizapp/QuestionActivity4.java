...
public class QuestionActivity4 extends AppCompatActivity {
    ...
    int wrong=0;
    String [] questions={"Which of the following is the correct syntax to declare a pointer in C++?",
            "Which of the following is not a feature of C++?",
            "Which of the following is used to define a class in C++?",
            "Which of the following header files is required for using cout and cin in C++?",
            "Which operator is used to allocate memory dynamically in C++?" };
    String [] options={"int p;","int *p;","int &p;","int p*;",
            "Object-Oriented Programming","Operator Overloading","Garbage Collection","Encapsulation",
            "class keyword","struct keyword","object keyword","define keyword",
            "#include <stdio.h>","#include <conio.h>","#include <iostream>","#include <stdlib.h>",
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ansText.equals(answers[flag])){
                    correct++;
                    Toast.makeText(QuestionActivity4.this, "Hurry!! it was correct", Toast.LENGTH_SHORT).show();
                }else{
                    wrong++;
                }
                flag++;
